...
#' @example
#' \dontrun{
#'  isoRes <- isoDist("C6H6", chrg = 0, limri=0.00000001, limitfin=0.009, rv=10000)
#'  print(isoRes)
#'          mz  prob relInt   iso
#'  1 78.04695 0.935    100   12C
#'  2  79.0503 0.063  6.735 13C 1
#'  3 80.05366 0.002  0.189 13C 2
#'  4 79.05323 0.001   0.06  2H 1
#'  }
#'
#'
isoDist <- function(mf, chrg=0, limri=0.00000001, limitfin=0.009, rv=10000)
    {
    ...
    names(res) <- c("mz", "prob", "relInt", "iso")
    return(res)
  }
