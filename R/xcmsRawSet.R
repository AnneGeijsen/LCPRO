...
#' @param ppm a numeric value for maximum tolerated ppm deviation in consecutive scans in ppm
...
#' @export
xcmsRawSet <- function(filepath, info, ppm, snthresh, peakwidth)
  {
